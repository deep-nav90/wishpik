...
<script src="{{asset('public/customer/js/jquery.min.js')}}"></script>
		<script src="{{asset('public/customer/js/jquery-migrate.js')}}"></script>
		<script src="{{asset('public/customer/js/popper.min.js')}}"></script>
		<script src="{{asset('public/customer/js/bootstrap.min.js')}}"></script>
		<script src="{{asset('public/customer/js/slickslider.min.js')}}"></script>
		<script src="{{asset('public/customer/js/charts.js')}}"></script>
		<script src="{{asset('public/customer/js/countdown.min.js')}}"></script>
		<script src="{{asset('public/customer/js/final-countdown.min.js')}}"></script>
		<script src="{{asset('public/customer/js/circle-progress.min.js')}}"></script>
