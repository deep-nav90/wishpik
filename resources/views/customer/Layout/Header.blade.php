...
<html class="no-js" lang="zxx">
	<head>
		...
		<!-- Fav Icon -->
		<link rel="icon" href="public/customer/img/favicon.png">
		

		<!-- NFTMax Stylesheet -->
		<link rel="stylesheet" href="{{asset('public/customer/css/bootstrap.min.css')}}">
		<link rel="stylesheet" href="{{asset('public/customer/css/font-awesome-all.min.css')}}">
		<link rel="stylesheet" href="{{asset('public/customer/css/charts.min.css')}}">
		<link rel="stylesheet" href="{{asset('public/customer/css/slickslider.min.css')}}">
		<link rel="stylesheet" href="{{asset('public/customer/css/reset.css')}}">
		<link rel="stylesheet" href="{{asset('public/customer/style.css')}}">
		
	</head>
	<body>
	
		<div class="body-bg" style="background-image:url('public/customer/img/body-bg.jpg')">
			...
			<div class="nftmax-smenu">
				...
				<div class="admin-menu">
					...
					<div class="logo">
						<a href="{{ url('/') }}">
							<img class="nftmax-logo__main" src="{{url('public/customer/img/logo-white.png')}} " alt="#">
						</a>
						<div class="nftmax__sicon close-icon"><img src="{{url('public/customer/img/menu-toggle.svg')}}" alt="#"></div>
					</div>
					<!-- Author Details -->
					...
					<div class="logout-button">
						<a class="nftmax-btn primary" data-bs-toggle="modal" data-bs-target="#logout_modal"><div class="logo-button__icon"><img src="public/customer/img/logout.png" alt="#"></div><span class="menu-bar__name">Signout</span></a>
					</div>
				</div>
				<!-- End Admin Menu -->
			</div>
					...
					<div class="modal-content nftmax-preview__modal-content">
						...
						<div class="modal-body nftmax-modal__body modal-body nftmax-close__body">
							<div class="nftmax-preview__close">
								<div class="nftmax-preview__close-img"><img src="public/customer/img/close.png" alt="#"></div>
					...
					<div class="row g-50">
						<div class="col-12">
							...
							<div class="nftmax-header__inner">
								<div class="nftmax__sicon close-icon d-xl-none"><img src="public/customer/img/menu-toggle.svg" alt="#"></div>
								<div class="nftmax-header__left">
									<!-- Search Form -->
									<div class="nftmax-header__form">
										<form class="nftmax-header__form-inner" action="#">
											<button class="search-btn" type="submit"><img src=""{{url('public/customer/img/search.png')}}" alt="#"></button>
								...
								<div class="nftmax-header__right">
									<div class="nftmax-header__group">
										...
										<div class="nftmax-header__amount">
											<div class="nftmax-amount__icon"><img src="public/customer/img/bag-icon.svg" alt="#"></div>
											<div class="nftmax-amount__digit"><span>$</span> 234,435.34</div>
											<div class="nftmax-header__plus"><a href="#"><img src="public/customer/img/plus-icon.svg" alt="#"></a></div>
												...
												<div class="nftmax-header__author">
													...
													<div class="nftmax-balance nftmax-profile__hover">
														...
														<ul class="nftmax-balance_list">
															<li>
																<div class="nftmax-balance-info">
																	<div class="nftmax-balance__img nftmax-profile__img-one"><img src="public/customer/img/profile-1.png" alt="#"></div>
																	<h4 class="nftmax-balance-name"><a href="{{url('/my-profile')}}">My Profile</a></h4>
																</div>
															</li>
															<li>
																<div class="nftmax-balance-info">
																	<div class="nftmax-balance__img nftmax-profile__img-two"><img src="public/customer/img/profile-2.png" alt="#"></div>
																	<h4 class="nftmax-balance-name"><a href="{{url('/message')}}">Message</a><span class="nftmax-profile__count">19</span></h4>
																</div>
															</li>
															<li>
																<div class="nftmax-balance-info">
																	<div class="nftmax-balance__img nftmax-profile__img-three"><img src="public/customer/img/profile-3.png" alt="#"></div>
																	<h4 class="nftmax-balance-name"><a href="{{url('/history')}}">History</a></h4>
																</div>
															</li>
															<li>
																<div class="nftmax-balance-info">
																	<div class="nftmax-balance__img nftmax-profile__img-four"><img src="public/customer/img/profile-4.png" alt="#"></div>
																	<h4 class="nftmax-balance-name"><a href="{{url('/setting')}}">Setting</a></h4>
																</div>
															</li>
															<li>
																<div class="nftmax-balance-info">
																	<div class="nftmax-balance__img nftmax-profile__img-five"><img src="public/customer/img/profile-5.png" alt="#"></div>
