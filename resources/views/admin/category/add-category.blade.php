              ...
              <form id="addCategory" enctype='multipart/form-data'>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="wish_date" id="wish_date" placeholder="Enter name">
                  </div>
                  ...
                  <img src="{{url('public/admin/image/dummy.jpg')}}" id="click_on_image" alt="" style="cursor:pointer;">
