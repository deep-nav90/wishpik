              ...
              <div class="upload_align">
                ...
                <div class="user_img mr-2" ui="image" title="Upload Image/Video/Audio" style="position: relative; margin-bottom: 16px;">
                    ...
                    <div class="add_img cross_icon">
                        <img class="click_upload plus_icon cross_icon cross_icon_old" del_id = "{{$productImage->id}}" ui="image" src="{{url('/public/admin/image/cross.png')}}" alt="cross">
                    </div>
    ...
    $(".file_upload_click").click(function(){
        ...
        $.each(files, function (i) {
            ...
            if(file){
                ...
                <div class="add_img cross_icon">
                    <img class="click_upload plus_icon cross_icon" ui="image" id="cross_`+acceptable_file_arr+`" src="{{url('/public/admin/image/cross.png')}}" alt="cross">
                </div>

                <div class="custom_check_wrap">
                    <div class="custom-check">
                    <input type="checkbox" data_id="`+acceptable_file_arr+`" class="featured_checkbox_new chec" type_of_check="new" name="old_checkbox[]" value="`+acceptable_file_arr+`">
                    <span></span>       
                    </div>
