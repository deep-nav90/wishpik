...
<div class="content-wrapper">
            ...
            <div class="card card-primary">
              ...
              <table class="table table-bordered" id="dynamicTable">  
                    ...
                    <tr>  
                        ...
                        <td><button type="button" name="add" id="add" class="btn btn-success">Add Wish</button></td>  
                    </tr>  
                </table>
              </div>
              <div class="upload_align">
                <div class="user_img mr-2" title="Click to upload images" style="
                  ...
                  <img class="click_upload img_upload file_upload_click" src="{{url('/public/admin/image/dum5_l.jpg')}}" style="cursor: pointer;" alt="woman">
                </div>
              </div>
  ...
  <script type="text/javascript">
   ...
   $("#add").click(function(){
       ...
       $("#dynamicTable").append('<tr><td><input type="text" name="wishtext['+i+'][wish]" placeholder="Enter your Wish" class="form-control wishtext" /></td><td><button type="button" class="btn btn-danger remove-tr">Remove</button></td></tr>');
   });
            ...
            $("#files_" + __count).on("change", function (event) {
                ...
                if (error == "false") {
                        ...
                        if (file) {
                            if (file.type == "image/jpeg" || file.type == "image/jpg" || file.type == "image/png") {
                                ...
                                reader.onload = function (e) {
                                    ...
                                    $(".upload_align").append(
                                        `<div class="user_img mr-2" ui="image" style="position: relative; margin-bottom: 16px;">
                  <img class="click_upload img_upload" id="accept_` +
                                            acceptable_file_arr +
                                            `" src="` +
                                            e.target.result +
                                            `" alt="woman">
                  ...
                  <div class="add_img cross_icon">
                    <img class="click_upload plus_icon cross_icon" ui="image" id="cross_` +
                                            acceptable_file_arr +
                                            `" src="{{url('/public/admin/image/cross.png')}}" alt="cross">
                  </div>
                  ...
                  <div class="custom_check_wrap">
                    <div class="custom-check">
                      <input type="checkbox" data_id="` +
                                            acceptable_file_arr +
                                            `" class="featured_checkbox_new chec" type_of_check="new" name="old_checkbox[]" value="` +
                                            acceptable_file_arr +
                                            `">
                      <span></span>       
                    </div>
